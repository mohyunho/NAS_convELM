...
from utils.convELM_predictor import SimpleNeuroEvolutionTask
...
def main():
    ...
    if obj == "soo":
        ...
        mutate_log_path = os.path.join(directory_path, 'mute_log_cnn_%s_%s_%s_%s.csv' % (pop_size, n_generations, obj, trial))
