...
class SimpleNeuroEvolutionTask(Task):
    ...
    def evaluate(self, genotype):
        ...
        convELM_model = ConvElm(feat_len, win_len, conv1_ch_mul, conv1_kernel_size, conv2_ch_mul, conv2_kernel_size, conv3_ch_mul, conv3_kernel_size, fc_mul, l2_parm, self.model_path).to(self.device)
