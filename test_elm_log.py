...
from utils.convELM_network_cnn import train_net_cnn, test_net
...
def main():
    ...
    for idx, row in ea_log_df.iterrows():
        ...
        validation = train_net_cnn(convELM_model, train_sample_array, train_label_array, test_sample_array, test_label_array, l2_parm, ep, device)
        test_rmse_lst.append(validation[0])



    ############ append test RMSE to df
    ea_log_df["test_rmse"] = test_rmse_lst
